...
2. Read, in order (skip any missing): `SUMMARY.md`, `metadata.md`, `timeline.md`,
   `transcript.md`, `frames/*.jpg`, `frames/ocr-combined.md` from the printed directory.
   Report transcript provenance and do not imply complete viewing without inspecting the
   relevant artifacts and frames.
